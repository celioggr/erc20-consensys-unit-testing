...
let HST;
let HST2;
const contract2test = OpenZeppelin;
const contract_name = 'OpenZeppelin';
const contract_symbol = "OZP";
...
contract(contract_name, (accounts) => {
  beforeEach(async () => {
    HST = await contract2test.new(10000,"OpenZeppelin","OZP",10,{ "from": accounts[0] });
    HST2 = await contract2test.new(maxtokens, 'XYZ','XYZ',1,{ "from": accounts[0] });
  });
